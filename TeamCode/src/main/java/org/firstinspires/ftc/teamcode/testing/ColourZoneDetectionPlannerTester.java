...
public class ColourZoneDetectionPlannerTester extends LinearOpMode {
    ...
    // Names in RC config
    public static String Z1A = "z1CSa";
    public static String Z2A = "z2CSa";
    public static String Z3A = "z3CSa";
    public static String Z1B = "z1CSb";
    public static String Z2B = "z2CSb";
    public static String Z3B = "z3CSb";
    ...
    public void runOpMode() {
        ...
        try {
            czd = new ColourZoneDetection(hardwareMap, Z1A, Z2A, Z3A, Z1B, Z2B, Z3B);
        } catch (Exception e) {
        ...
        while (opModeIsActive()) {
            ...
            List<ShotOrderPlanner.PlannedShot> plan = planner.plan(CIPHER, st, FORCE_SHOOT_ALL_ZONES);
