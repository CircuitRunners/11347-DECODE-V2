...
@Config
@Configurable
@Autonomous(name = "Red Side Auto Close 12", group = "Red Autos", preselectTeleOp = "MainTeleOpRED")
public class RedSideAutoClose12 extends OpMode {
    // ===================== GOAL / AUTO AIM =====================
    ...
    private PathChain line1, line2, line4, line7, line99;
    ...
    public void init() {
        ...
        telemetry.addData("Auto:", "Red Side Auto Close 12");
        telemetry.update();
    }
